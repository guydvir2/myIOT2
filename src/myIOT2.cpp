...
// ~~~~~~ myIOT2 CLASS ~~~~~~~~~~~ //
myIOT2::myIOT2() : mqttClient(espClient), flog("/myIOTlog.txt"), clklog("/clkLOG.txt"), _MQTTConnCheck(Chrono::SECONDS), _WifiConnCheck(Chrono::SECONDS), _NTPCheck(Chrono::SECONDS)
{
}
